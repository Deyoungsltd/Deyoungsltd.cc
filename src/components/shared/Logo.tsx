...
export function ElectronicsLogo({ className = "h-12" }: { className?: string }) {
  return (
    <img src="/logos/electronics_premium_1.png" alt="D'Young Electrical & Electronics" className={className} />
  );
}

export function BoleLogo({ className = "h-12" }: { className?: string }) {
  return (
    <img src="/logos/bole_premium_1.png" alt="D'Young's Pot" className={className} />
  );
}
